...
public class LamWools extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lam_wools);

        Button btn = findViewById(R.id.webSite);
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://url.kr/tSXMPD"));
                startActivity(intent);
            }
        });

        models = new ArrayList<>();
        models.add(new DressCodiModel(R.drawable.lam_wools));
        models.add(new DressCodiModel(R.drawable.lam_wools1));
        models.add(new DressCodiModel(R.drawable.lam_wools2));
        models.add(new DressCodiModel(R.drawable.lam_wools3));
