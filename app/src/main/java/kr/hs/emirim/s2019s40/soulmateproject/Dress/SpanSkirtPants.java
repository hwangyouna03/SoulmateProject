...
public class SpanSkirtPants extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_span_skirt_pants);

        Button btn = findViewById(R.id.webSite);
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://url.kr/DzXP17"));
                startActivity(intent);
            }
        });

        models = new ArrayList<>();
        models.add(new DressCodiModel(R.drawable.skirt_pants));
        models.add(new DressCodiModel(R.drawable.skirt_pants1));
        models.add(new DressCodiModel(R.drawable.skirt_pants2));
