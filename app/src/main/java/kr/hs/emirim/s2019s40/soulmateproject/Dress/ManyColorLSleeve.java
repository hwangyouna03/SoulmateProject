...
public class ManyColorLSleeve extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_many_color_l_sleeve);

        Button btn = findViewById(R.id.webSite);
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://url.kr/ezHf1n"));
                startActivity(intent);
            }
        });

        models = new ArrayList<>();
        models.add(new DressCodiModel(R.drawable.many_colors));
        models.add(new DressCodiModel(R.drawable.many_colors1));
        models.add(new DressCodiModel(R.drawable.many_colors));
        models.add(new DressCodiModel(R.drawable.many_colors3));
