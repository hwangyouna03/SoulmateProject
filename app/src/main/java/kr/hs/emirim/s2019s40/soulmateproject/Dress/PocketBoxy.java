...
public class PocketBoxy extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pocket_boxy);

        Button btn = findViewById(R.id.webSite);
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://url.kr/lPObGQ"));
                startActivity(intent);
            }
        });

        models = new ArrayList<>();
        models.add(new DressCodiModel(R.drawable.pocket_boxy));
        models.add(new DressCodiModel(R.drawable.pocket_boxy1));
        models.add(new DressCodiModel(R.drawable.pocket_boxy2));
