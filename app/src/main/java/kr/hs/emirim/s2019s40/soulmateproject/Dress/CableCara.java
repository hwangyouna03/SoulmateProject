...
public class CableCara extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cable_cara);

        Button btn = findViewById(R.id.webSite);
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://url.kr/COuBnQ"));
                startActivity(intent);
            }
        });

        models = new ArrayList<>();
        models.add(new DressCodiModel(R.drawable.cable_cara_onepiece));
        models.add(new DressCodiModel(R.drawable.cable_cara_onepiece2));
        models.add(new DressCodiModel(R.drawable.cable_cara_onepiece3));
