...
public class TwoDotsBakery extends AppCompatActivity implements OnMapReadyCallback {
    MapView mapView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        map.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://url.kr/afhC2J"));
