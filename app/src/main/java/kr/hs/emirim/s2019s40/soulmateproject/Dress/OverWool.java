...
public class OverWool extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_over_wool);

        Button btn = findViewById(R.id.webSite);
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://url.kr/Jh7uKR"));
                startActivity(intent);
            }
        });

        models = new ArrayList<>();
        models.add(new DressCodiModel(R.drawable.over_wool));
        models.add(new DressCodiModel(R.drawable.over_wool1));
        models.add(new DressCodiModel(R.drawable.over_wool2));
        models.add(new DressCodiModel(R.drawable.over_wool3));
