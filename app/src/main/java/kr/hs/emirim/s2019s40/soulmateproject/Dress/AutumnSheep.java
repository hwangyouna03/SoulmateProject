...
public class AutumnSheep extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_autumn_sheep);

        Button btn = findViewById(R.id.webSite);
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://url.kr/wTnlcv"));
                startActivity(intent);
            }
        });

        models = new ArrayList<>();
        models.add(new DressCodiModel(R.drawable.autumnsheep));
        models.add(new DressCodiModel(R.drawable.autumnsheep1));
        models.add(new DressCodiModel(R.drawable.autumnsheep2));
        models.add(new DressCodiModel(R.drawable.autumnsheep3));
