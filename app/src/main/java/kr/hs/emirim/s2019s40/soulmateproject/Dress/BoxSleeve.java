...
public class BoxSleeve extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_box_sleeve);

        Button btn = findViewById(R.id.webSite);
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://url.kr/4b8Fpn"));
                startActivity(intent);
            }
        });

        models = new ArrayList<>();
        models.add(new DressCodiModel(R.drawable.box_sleeve1));
        models.add(new DressCodiModel(R.drawable.box_sleeve2));
        models.add(new DressCodiModel(R.drawable.box_sleeve3));
        models.add(new DressCodiModel(R.drawable.box_sleeve4));
