...
public class HwanseonCave extends AppCompatActivity implements Button.OnClickListener{
    LinearLayout starReview, blogReview;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_hwanseon_cave);

        Button btn = findViewById(R.id.hwanseon_cave_ticket);
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(getApplicationContext());
                builder.setTitle("예매").setMessage("이 장소는 현장 결제만 가능므로 예매를 할 수 없습니다." +
                        "죄송합니다 :-(");
