...
public class BltStake extends AppCompatActivity implements OnMapReadyCallback {
    MapView mapView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_blt_stake);

        Button btn1 = findViewById(R.id.blt_steak_map);
