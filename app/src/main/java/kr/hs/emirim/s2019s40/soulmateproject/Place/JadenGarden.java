...
public class JadenGarden extends AppCompatActivity implements OnMapReadyCallback {
    MapView mapView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn1 = findViewById(R.id.jaden_garden_map);
        btn1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://map.naver.com/v5/entry/place/19928010?c=14197571.2850594,4555458.1818829,15,0,0,0,dh"));
                startActivity(intent);
            }
        });
        ...
        blog1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://blog.naver.com/loveskychild/222149066683"));
                startActivity(intent);
            }
        });
        ...
        blog2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://blog.naver.com/anndam/222120201841"));
                startActivity(intent);
            }
        });
        ...
        blog3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://blog.naver.com/kizaki56/222088925568"));
                startActivity(intent);
            }
        });
        ...
        blog4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://blog.naver.com/yajeung/222110697370"));
                startActivity(intent);
            }
        });
        ...
        blog5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://blog.naver.com/dlscjf517/222129004675"));
                startActivity(intent);
            }
        });
