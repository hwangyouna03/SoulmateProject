...
public class SwissTemapark extends AppCompatActivity implements OnMapReadyCallback {
    MapView mapView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://map.naver.com/v5/entry/place/34559812?c=14185441.6841334,4532954.6430243,13,0,0,0,dh"));
                startActivity(intent);
            }
        });
        ...
        blog1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://blog.naver.com/dkzkdlqk/222124182015"));
                startActivity(intent);
            }
        });
        ...
        blog2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://blog.naver.com/somdari496/222117279315"));
                startActivity(intent);
            }
        });
        ...
        blog3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://blog.naver.com/eumjeongoh/222117306656"));
                startActivity(intent);
            }
        });
        ...
        blog4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://blog.naver.com/jyleen/222107315354"));
                startActivity(intent);
            }
        });
        ...
        blog5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://blog.naver.com/priceton/222099805924"));
                startActivity(intent);
            }
        });
