...
public class PuffLongOnepiece extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_puff_long_onepiece);

        Button btn = findViewById(R.id.webSite);
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://url.kr/ENoGUy"));
                startActivity(intent);
            }
        });

        models = new ArrayList<>();
        models.add(new DressCodiModel(R.drawable.fluff_mantoman_onepiece1));
        models.add(new DressCodiModel(R.drawable.fluff_mantoman_onepiece2));
        models.add(new DressCodiModel(R.drawable.fluff_mantoman_onepiece3));
