    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://url.kr/wpAUGK"));
                startActivity(intent);
            }
        });

        models = new ArrayList<>();
        models.add(new DressCodiModel(R.drawable.flowerbeach));
        models.add(new DressCodiModel(R.drawable.flowerbeach1));
        models.add(new DressCodiModel(R.drawable.flowerbeach2));
        models.add(new DressCodiModel(R.drawable.flowerbeach3));
