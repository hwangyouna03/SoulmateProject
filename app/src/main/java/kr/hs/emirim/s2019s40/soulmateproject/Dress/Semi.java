...
public class Semi extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://url.kr/eyUwmN"));
                startActivity(intent);
            }
        });

        models = new ArrayList<>();
        models.add(new DressCodiModel(R.drawable.seminack));
        models.add(new DressCodiModel(R.drawable.seminack1));
        models.add(new DressCodiModel(R.drawable.seminack2));
