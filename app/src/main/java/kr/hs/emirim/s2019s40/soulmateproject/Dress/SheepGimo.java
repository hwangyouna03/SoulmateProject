...
public class SheepGimo extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sheep_gimo);

        Button btn = findViewById(R.id.webSite);
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://url.kr/t2NAuD"));
                startActivity(intent);
            }
        });

        models = new ArrayList<>();
        models.add(new DressCodiModel(R.drawable.sheep_gimo));
        models.add(new DressCodiModel(R.drawable.sheep_gimo1));
        models.add(new DressCodiModel(R.drawable.sheep_gimo2));
