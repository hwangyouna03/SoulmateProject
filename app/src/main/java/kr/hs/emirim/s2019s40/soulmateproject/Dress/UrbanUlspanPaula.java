...
public class UrbanUlspanPaula extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_urban_ulspan_paula);

        Button btn = findViewById(R.id.webSite);
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://url.kr/ECuGUm"));
                startActivity(intent);
            }
        });

        models = new ArrayList<>();
        models.add(new DressCodiModel(R.drawable.urban_ulspan_paulr));
        models.add(new DressCodiModel(R.drawable.urban_ulspan_paulr2));
        models.add(new DressCodiModel(R.drawable.urban_ulspan_paulr3));
